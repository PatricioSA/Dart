...
void main() {
  ...
  print('Data da Saída do Pedido: ${dataSaida.exibirData()}');
  ...
  //Nova data com parâmetro opcional no construtor
  Data dataOpcional = new Data();
  print('--- Novas datas com parâmetros opcionais no construtor');
